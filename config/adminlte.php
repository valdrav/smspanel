...
return [
    ...
    */
    ...
    'classes_sidebar' => 'sidebar-dark-indigo elevation-4 sidebar-modern',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'SMS Paketleri',
            'route' => 'admin.packages.catalog',
            'icon' => 'fas fa-fw fa-box',
            'can' => 'packages.view',
        ],
        [
            'text' => 'Paket Siparişleri',
            'route' => 'admin.package-orders.index',
            'icon' => 'fas fa-fw fa-shopping-cart',
            'can' => ['packages.manage', 'packages.purchase'],
        ],
        [
            'text' => 'Paket Yönetimi',
        ...
        [
            ...
            'can' => ['tickets.view', 'tickets.create'],
        ],
        ['header' => 'SİSTEM'],
        [
        ...
        'SmsPanelTheme' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'css/smspanel-theme.css',
                ],
            ],
        ],
        'Datatables' => [
